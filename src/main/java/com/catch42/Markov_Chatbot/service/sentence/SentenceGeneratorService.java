...
public class SentenceGeneratorService {
    ...
    public String generateString(String starter) {
        ...
        List<Integer> intList = IntStream.range(this.nFactor - this.variance, this.nFactor + this.variance).boxed()
        ...
        while (actualLength > 0 && blankNextKeyEntryNotFound) {
            ...
            List<MarkovChain> currentEntries = this.markovGeneratorService
                    .convertHibernateResultsToTextEntryList(queryResults);
    ...
    public String getRandomStarterString() {
        ...
        if (randomlySelectedTextEntryId != null) {
            List<Object[]> randomMarkovChain = this.markovChainRepository
                    .getMarkovChainById(randomlySelectedTextEntryId);
            List<MarkovChain> randomEntries = this.markovGeneratorService
                    .convertHibernateResultsToTextEntryList(randomMarkovChain);
