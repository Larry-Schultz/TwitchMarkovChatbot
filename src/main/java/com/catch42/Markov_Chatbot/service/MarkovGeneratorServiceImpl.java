...
public class MarkovGeneratorServiceImpl extends MarkovGeneratorServiceAbstract {
    ...
    /**
     * hibernate results come in as List<Object[]>, but to make these results useable it needs to be in List<TextEntry>.
     * so let's convert them here in the factory class.
     * 
     * @param queryResults
     * @return
     */
