...
public class IrcChatbotThread extends Thread {
    ...
    public IrcChatbotThread(String username, String password, String channel, Router<ChatMessage> chatMessageRouter) {
        ...
        Configuration configuration = new Configuration.Builder().setAutoNickChange(false) // Twitch doesn't support
                                                                                           // multiple users
                ...
                .addServer("irc.twitch.tv").setName(username) // Your twitch.tv username
