...
public class QueueRouterConfig {
    ...
    @Bean
    public Router<ChatMessage> chatMessageRouter(Queue<ChatMessage> repositoryBoundChatMessagesQueue,
            Queue<ChatMessage> websocketBoundChatMessagesQueue) {
    ...
    @Bean
    public Router<String> generatedSentenceRouter(Queue<String> commandLineExampleSentenceQueue,
            Queue<String> websocketBoundSentenceQueue) {
